...
log_level = "INFO"
work_dir = "work_dirs/sparse4dv3_temporal_r50_1x8_bs4_512x1408"
...
model = dict(
    ...
    img_backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained', checkpoint='ckpts/cascade_mask_rcnn_r101_fpn_1x_nuim_20201024_134804-45215b1e.pth', prefix="backbone."),
    ),
    img_neck=dict(
        type="FPN",
        num_outs=num_levels,
